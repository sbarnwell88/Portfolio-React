    ...
    render() {
        return (
            ...
            <div>
                ...
                <p>How does all this fits into web development?</p>
                <p>My international & business experience allows me to understand users from various cultures, backgrounds, and life experiences.</p>
            </div>
            </Description>
            </Background>
        );
